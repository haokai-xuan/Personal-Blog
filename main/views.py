...
class IndexView(generic.TemplateView):
	...
	def get_context_data(self, **kwargs):
		...
		testimonials = Testimonial.objects.filter(is_active=True) # Only true objects displayed, can in change by admin
...
class BlogView(generic.ListView):
    ...
    paginate_by = 10
    ordering = ['-timestamp']  # Add this line to order by most recent first
